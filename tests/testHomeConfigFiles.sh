...
testLocalExistBinFiles() {
    ...
    assertTrue ": 109 :${red}${bold}[FAIL]${reset} stage_config not found.		" "[ -f $HOME/bin/stage_config ]"
    assertTrue ": 117 :${red}${bold}[FAIL]${reset} foldering media by date not found.	" "[ -f $HOME/bin/filesByDate ]"
    assertTrue ": 117 :${red}${bold}[FAIL]${reset} foldering files by type not found.   " "[ -f $HOME/bin/filesByType ]"
    assertTrue ": 113 :${red}${bold}[FAIL]${reset} enviroment_config not found.		" "[ -f $HOME/bin/enviroment_config ]"
    assertTrue ": 114 :${red}${bold}[FAIL]${reset} get_packs_env not found.		" "[ -f $HOME/bin/get_packs_enviroment ]"
    assertTrue ": 115 :${red}${bold}[FAIL]${reset} get_packs_virtmanager not found.	" "[ -f $HOME/bin/get_packs_virtmanager ]"
    assertTrue ": 116 :${red}${bold}[FAIL]${reset} i3_config not found.			" "[ -f $HOME/bin/i3_config ]"
    assertTrue ": 120 :${red}${bold}[FAIL]${reset} push_config not found.		" "[ -f $HOME/bin/push_config ]"
    assertTrue ": 121 :${red}${bold}[FAIL]${reset} bare repo pull not found.		" "[ -f $HOME/bin/bare_repo_pull ]"
    assertTrue ": 122 :${red}${bold}[FAIL]${reset} local repo pull not found.		" "[ -f $HOME/bin/local_repo_pull ]"
    assertTrue ": 123 :${red}${bold}[FAIL]${reset} bkp_cfg_files not found.		" "[ -f $HOME/bin/bkp_cfg_files ]"
    assertTrue ": 124 :${red}${bold}[FAIL]${reset} uninstall_bare_cfg not found.	" "[ -f $HOME/bin/uninstall_bare_cfg ]"
    assertTrue ": 125 :${red}${bold}[FAIL]${reset} config check not found.		" "[ -f $HOME/bin/config_check ]"
    assertTrue ": 126 :${red}${bold}[FAIL]${reset} dotfiles_env not found.		" "[ -f $HOME/bin/dotfiles_env ]"
    assertTrue ": 127 :${red}${bold}[FAIL]${reset} dirs_config  not found.		" "[ -f $HOME/bin/dirs_config ]"
    assertTrue ": 128 :${red}${bold}[FAIL]${reset} git_config  not found.		" "[ -f $HOME/bin/git_config ]"
    assertTrue ": 129 :${red}${bold}[FAIL]${reset} ssh_config  not found.		" "[ -f $HOME/bin/ssh_config ]"
